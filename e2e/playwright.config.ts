...
export default defineConfig({
  ...
  projects: [
    {
      name: 'git-mode',
      testMatch: /^(?!.*\.(filemode|singlefile|multifile|nogit|rangemode|mobile|designmode)\.).*\.spec\.ts$/,
      use: {
    ...
    {
      // Mobile project: touch emulation at 375×812 against the git-mode fixture.
      name: 'mobile',
